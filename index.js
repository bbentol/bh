			...
			if (type == 'conversation') {
				...
				if (body.startsWith('#gtts ')) {
				   ...
				   client.sendMessage(from, buffer, msgType.image, {quoted: mek})
					...
					client.sendMessage(from, buffer, msgType.image, {quoted: mek, caption: 'Kyaaa >//<'})
					...
					const teks = encodeURIComponent(body.slice(3))
						if (!teks) return client.sendMessage(from, 'Masukan Teks', msgType.text, {quoted: mek})
					...
					const teks = encodeURIComponent(body.slice(6))
						if (!teks) return client.sendMessage(from, 'Input teks yang ingin di tulis', msgType.text, {quoted: mek})
					const buffer = await getBuffer(`https://api.vhtear.com/pornlogo?text=${teks}&apikey=${vkey}`)
					client.sendMessage(from, buffer, msgType.image, {quoted: mek})
					...
					const teks = encodeURIComponent(body.slice(7))
						if (!teks) return client.sendMessage(from, 'Input teks yang ingin di tulis', msgType.text, {quoted: mek})
					const buffer = await getBuffer(`https://api.vhtear.com/googletext?text=${teks}&apikey=${vkey}`)
					client.sendMessage(from, buffer, msgType.image, {quoted: mek})
					...
					client.sendMessage(from, buffer, msgType.image, {quoted: mek})
				} else if (body.startsWith('#tti')) {
					const teks = encodeURIComponent(body.slice(7))
						if (!teks) return client.sendMessage(from, 'Input teks yang ingin di tulis', msgType.text, {quoted: mek})
					const buffer = await getBuffer(`https://api.vhtear.com/textmaker?text=${teks}&apikey=${vkey}`)
					client.sendMessage(from, buffer, msgType.sticker, {quoted: mek})
				} else if (body.startsWith('#yt')) {
					const teks = encodeURIComponent(body.slice(4))
						if (!teks) return client.sendMessage(from, 'Input teks yang ingin di tulis', msgType.text, {quoted: mek})
					const buffer = await getBuffer(`https://api.vhtear.com/ytdl?link=${uri}&apikey=${vkey}`)
					client.sendMessage(from, buffer, msgType.video, {quoted: mek})
